 ...
 * <p>
 * <b>Имя, а не путь.</b> Файловые модули ищутся от корня проекта. Встроенный модуль
 * ищется по написанному имени раньше файла, независимо от корня проекта.
 * Отсюда и способ явно
