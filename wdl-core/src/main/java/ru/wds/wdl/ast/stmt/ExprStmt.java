 ...
 * ничего не делает — это почти наверняка опечатка, и парсер о ней скажет. Сейчас
 * в этой роли разрешён только вызов; когда появятся {@code i++} и другие операции
 * с эффектом, список расширится ровно на них.
 *
