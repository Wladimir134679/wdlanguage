...
| [Типы данных](types.md) | двенадцать типов, их правила и внутреннее устройство, истинность, равенство, печать |
...
| [Байты](bytes.md) | тип `bytes` и модуль `sys.bytes`: `Writer` и `Reader`, знаковый байт, словарь видов числа, байтовый ввод-вывод, предел выделения |
