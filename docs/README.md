...
| [Инструментам](tooling.md) | позиции и их единицы, режим лексера с комментариями, обход дерева `Nodes`, интервалы имён и анализ имён (`FileAnalysis`) — то, на чём строятся редактор и LSP |
