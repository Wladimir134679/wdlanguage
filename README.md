...
* [Инструментам](docs/tooling.md) — позиции и их единицы, режим лексера с комментариями,
  обход дерева `Nodes`, интервалы имён, инварианты интервалов: то, на чём строятся
  подсветка, переход к объявлению, форматтер и LSP.
...
Слоя анализа имён (что видно в этой точке файла) пока нет: он живёт планом
