...
| `wdl-interop` | мост в Java: чужой класс и готовый объект как класс и объект языка | `core` |
...
Чужой Java-класс отдаётся скрипту без описания руками: `wdl-interop` снимает
